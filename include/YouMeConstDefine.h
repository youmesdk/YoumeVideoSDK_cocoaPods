...
typedef enum YOUME_SERVER_DEPLOY_MODE {
    YOUME_SERVER_DEPLOY_MODE_DEFAULT      = 0,    // 默认模式
    YOUME_SERVER_DEPLOY_MODE_EXTRANET     = 1,    // 外部网络模式
    YOUME_SERVER_DEPLOY_MODE_INTRANET     = 2     // 内部网络模式
} YOUME_SERVER_DEPLOY_MODE_t;
...
typedef enum YOUME_RTC_SERVER_REGION {
    ...
    RTC_NAF_SERVER      = 17, // 北非, north africa
    RTC_CAF_SERVER      = 18, // 中非
    RTC_SAF_SERVER      = 19, // 南非
    RTC_EAF_SERVER      = 20, // 东非
    RTC_WAF_SERVER      = 21, // 西非
    RTC_RUS_SERVER      = 22, // 俄罗斯

    RTC_NCN_SERVER      = 201, // 华北, north china
    RTC_NECN_SERVER     = 202, // 东北
    RTC_ECN_SERVER      = 203, // 华东
    RTC_CCN_SERVER      = 204, // 华中
    RTC_SCN_SERVER      = 205, // 华南
    RTC_WSCN_SERVER     = 206, // 西南
...
{
	RECORD_TYPE_AUDIO_NONE = 10,//不要录制音频
	RECORD_TYPE_AUDIO_MIC,		//mic声音
